...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    bg_image = PILtoTorch(cam_info.bg_image, resolution) if cam_info.bg_image is not None else None
    loaded_mask = PILtoTorch(cam_info.mask, resolution) if cam_info.mask is not None else None

    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  FoVx=cam_info.FovX, FoVy=cam_info.FovY, cx=cam_info.cx, cy=cam_info.cy,
                  image=gt_image, gt_alpha_mask=loaded_mask, bg_image=bg_image,
